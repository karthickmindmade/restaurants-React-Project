...
import AdminEditproductcontent from '../AdminEditProduct/AdminEditProductContent';
import { useLocation } from 'react-router-dom/esm/react-router-dom';
export default function AdminProductDetailcontent(props) {
    ...
    return (
        <div className="ms-content-wrapper">
            {open === false ? <div className="row">
                ...
                <AdminEditproductcontent close={() => setopen(false)} vendor={cakedetails} />
            }
        </div>
