...
import Breadcrumb from '../AdminProductsdetail/Breadcrumb';
import { useDispatch, useSelector } from 'react-redux';
import actions from '../../../redux/cake/actions';
import SelectOption from '../../common/selectOption';
import EditProductslider from './editImageSlider';
import ImgSelectOption from '../../vendor/section/Addproduct/imgSelect';
import SuccessAlert from '../../common/SuccessAlert';
import FailAlert from '../../common/failAlert';
import CircleDotSpinner from '../../common/CircleDotSpinner';

export default function AdminEditproductcontent(props) {
    const { vendor } = props
    const Title = useRef();
