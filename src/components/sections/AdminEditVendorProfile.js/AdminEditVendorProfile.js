...
import Breadcrumb from '../../sections/AdminEditVendorProfile.js/Breadcrumb';
import actions from '../../../redux/Vendor/actions';
function AdminEditVendorProfileContent(props) {
...
export default AdminEditVendorProfileContent;